...
const testCases = [
  ...
  },
  {
    ...
    muscles: ["lats"],
    expected: "isolation",
  }, // Tricky: usually pull but often considered isolation for lats
  {
    name: "Leg Extension",
    region: "legs",
    cat: "strength",
...
for (const tc of testCases) {
  ...
  console.log(
    `${tc.name.padEnd(25)} | Result: ${result.padEnd(10)} | Expected: ${tc.expected.padEnd(10)} | ${result === tc.expected ? "✅" : "❌"}`,
  );
}
